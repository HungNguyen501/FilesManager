package com.example.filesmanagement;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.custom_color));
    ...
    private void showTextViewCustomDialog(String path) {
        final Dialog customDialog = new Dialog(MainActivity.this);
        customDialog.setContentView(R.layout.custom_dialog_textview);
    ...
    private void showImageViewCustomDialog(String path) {
        final Dialog customDialog = new Dialog(MainActivity.this);
        customDialog.setContentView(R.layout.custom_dialog_imageview);
